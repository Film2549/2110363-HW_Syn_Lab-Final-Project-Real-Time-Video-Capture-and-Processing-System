...
REM
REM Generated by Vivado on Thu May 14 11:07:44 +0700 2026
...
echo "xvlog --incr --relax -prj tb_framebuffer_dualport_vlog.prj"
call xvlog  --incr --relax -prj tb_framebuffer_dualport_vlog.prj -log xvlog.log
